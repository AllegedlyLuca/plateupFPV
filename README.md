...
I was first introduced to the idea of a first person view for PlateUp via the Steam Workshop mod posted by TW年糕醬 (linked below).  This mod linked to Spiffy's source.  TW's mod has distinct differences to this one, namely in that you can cycle tracked players and change to external follow-cams.  I do not plan on adding either of those features to this mod, nor the minimap.  If you wish for those features, please use TW's mod.  He worked on his mod at least as much as I have on this variant of Spiffy's mod, and it's worth looking at.
